...
<div class="bg-white shadow-sm rounded-lg border border-gray-200">
    <div class="px-6 py-5 border-b border-gray-200">
        <h2 class="text-xl font-semibold text-gray-900">Tambah Master Pegawai</h2>
    </div>
    
    <form action="{{ route('master-manajemen.master-pegawai.store') }}" method="POST" class="p-6" id="formPegawai">
        @csrf
