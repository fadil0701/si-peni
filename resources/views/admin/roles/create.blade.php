...
<div class="bg-white shadow-sm rounded-lg border border-gray-200">
    <div class="px-6 py-5 border-b border-gray-200">
        <h2 class="text-xl font-semibold text-gray-900">Tambah Role</h2>
    </div>
    ...
    <form action="{{ route('admin.roles.store') }}" method="POST" class="p-6">
        ...
        <div class="space-y-6">
            <div>
                ...
                @enderror
                <p class="mt-1 text-xs text-gray-500">Gunakan huruf kecil dan underscore (contoh: admin_gudang)</p>
            </div>
            ...
            <div>
                ...
                <p class="mt-2 text-xs text-gray-500">
                    <span id="selected-count" class="font-medium text-blue-600">0</span> permission dipilih
                </p>
            </div>
