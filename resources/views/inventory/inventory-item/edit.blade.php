...
<div class="bg-white shadow-sm rounded-lg border border-gray-200">
    ...
    <form action="{{ route('inventory.inventory-item.update', $inventoryItem->id_item) }}" method="POST" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <img src="{{ asset('storage/' . $inventoryItem->qr_code) }}" alt="QR Code" class="h-32 w-32 border border-gray-300 rounded-md">
                    <div>
                        <p class="text-sm text-gray-600">Kode Register: <span class="font-semibold">{{ $inventoryItem->kode_register }}</span></p>
                        <a href="{{ asset('storage/' . $inventoryItem->qr_code) }}" download class="mt-2 inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
