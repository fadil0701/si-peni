            ...
            if ($table === 'permintaan_barang') {
                if ($key === 'status_permintaan') {
                    ...
                    if (!in_array($value, $validStatuses)) {
                        ...
                        $this->warn("    Warning: Invalid status_permintaan '{$value}' for permintaan_barang, defaulting to 'DRAFT'");
                        $value = 'DRAFT';
                    }
                }
